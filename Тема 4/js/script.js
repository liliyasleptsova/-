...
document.getElementById("ex3").innerHTML = getPonies(['Блум', 'Стелла', 'Флора', 'Дафна', 'Лейла', 'Текна'], 'феи')
document.getElementById("ex3").innerHTML += "<br>" + getPonies(['Блум', 'Стелла', 'Флора', 'Дафна', 'Лейла', 'Текна'], 'люди')
...
document.getElementById("ex6").innerHTML = getWithSpaces(["Yakuts", "never", "sleep"])


function getEpisodes({title, episodes}) {
    return `Аниме ${title} включает ${episodes} серий`
}
document.getElementById("ex8").innerHTML = getEpisodes({title: "Naruto", episodes: 700})


const triple = (x) => { return x * 3 }
document.getElementById("ex9").innerHTML = triple(6)
