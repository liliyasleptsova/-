...
document.getElementById("ex3").innerHTML = getInfo({street: 'kylakovscogo', building: 1, flat: 30})
...
document.getElementById("ex4").innerHTML = joinArrays({id: 1, name: "Lil"}, {course: 2, semestr: 6, name: "Sli"})